...
<script>
    tinymce.init({
        ...
        plugins: [
            ...
            "table contextmenu directionality paste textcolor code autosave"
        ],
        toolbar1: "restoredraft | bold italic underline hr | link unlink image media | styleselect forecolor backcolor paste | bullist numlist outdent indent | code preview ",
        entity_encoding: "raw",
