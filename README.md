...
Clone this repository and install the dependencies.
    ...
    $ git clone https://github.com/ozdemirburak/laravel-6-simple-cms.git && cd laravel-6-simple-cms
    $ composer install
...
Either Clone the repository using git clone: `git clone https://github.com/ozdemirburak/laravel-6-simple-cms.git` 
or install via <a target="_blank" href="https://github.com/ozdemirburak/laravel-6-simple-cms/archive/master.zip">zip</a> and extract 
...
then [follow these instructions](https://getcomposer.org/download/). Finally run, `composer install` in the `laravel-6-simple-cms` directory.
